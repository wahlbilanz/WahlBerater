...
export const loadPoliticalDataSuccess = createAction('[app] Load Political Data JSON Success', props<{ data: PoliticalData; wasCached: boolean }>());
export const loadPoliticalDataError = createAction('[app] Load Political Data JSON Error', props<{ error: Error }>());
export const loadPersonalDataSuccess = createAction('[app] Load Personal Data JSON Success', props<{ data: PersonalData; wasCached: boolean }>());
